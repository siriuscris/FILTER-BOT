...
API_ID = int(environ.get('API_ID', '20207267'))
API_HASH = environ.get('API_HASH', '6a75ba59168661fcda439a06780c4f87')
BOT_TOKEN = environ.get('BOT_TOKEN', "7632256229:AAFV5-JYrJzteA0d3zqmhknu7FT0RKXc2UU")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '420974325 384017633').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002313118412'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002634840888').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002532104944') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002355845965')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://sirius0045:NpGV0W696SGnQoIi@cluster0.sftcu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+bF8Lbvbhk8BhMDFl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+sU254JcBd3llOTE1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/+AgnxABzePZMyMDg9') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Christy1998')
